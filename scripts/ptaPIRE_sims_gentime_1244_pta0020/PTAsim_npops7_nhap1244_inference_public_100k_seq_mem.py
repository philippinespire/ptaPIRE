...
plt.savefig("outputs/npops7_nhap1244_mumidhi_sigmalohi_muplot_public_100k_nocol")
plt.close()
t = "r_modern_sigma"
plt.scatter(variable_y_train[t], variable_y_pred[:, 1], alpha=0.01)
plt.savefig("outputs/npops7_nhap1244_mumidhi_sigmalohi_sigmaplot_public_100k_nocol")
sfs_list = []
